...
<form action="<?php echo html_output($form_action); ?>" name="addgroup" method="post" class="form-horizontal">
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<textarea name="add_group_form_description" id="add_group_form_description" class="ckeditor form-control"><?php echo (isset($add_group_data_description)) ? $add_group_data_description : ''; ?></textarea>
		</div>
	</div>
